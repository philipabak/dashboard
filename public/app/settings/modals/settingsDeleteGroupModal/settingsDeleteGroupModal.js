...
angular
    ...
    SaveModalCtrl.$inject = ['$scope', '$modalInstance', 'Setting'];
	 ...
	 * @memberOf dashboards
	 */
	function SettingsDeleteGroupModalCtrl($scope, $modalInstance, Setting) {
		...
		$scope.deleteGroup = function() {
            ...
            Setting.deleteGroup(settingInfo.groupId).then(successDeleteGroup, error);
